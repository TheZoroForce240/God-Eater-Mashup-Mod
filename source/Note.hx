...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false)
	{
		...
		else if (mania == 2) frameN = ['purple', 'blue', 'green', 'red', 'white', 'yellow', 'violet', 'jonquil', 'dark'];
		else if (mania == 3) frameN = ['purple', 'blue', 'green', 'red', 'white', 'orange', 'yellow', 'violet', 'jonquil', 'dark'];
