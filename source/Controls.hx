...
enum abstract Action(String) to String from String
{
	...
	var NN0_R = "nn0-release";
	var NN1_R = "nn1-release";
	var NN2_R = "nn2-release";
	var NN3_R = "nn3-release";
	var NN4_R = "nn4-release";
	var NN5_R = "nn5-release";
	var NN6_R = "nn6-release";
	var NN7_R = "nn7-release";
	var NN8_R = "nn8-release";
	var NN9_R = "nn9-release";
}
#else
@:enum
...
class Controls extends FlxActionSet
{
	...
	var _nn0 = new FlxActionDigital(Action.NN0);
	var _nn1 = new FlxActionDigital(Action.NN1);
	var _nn2 = new FlxActionDigital(Action.NN2);
	var _nn3 = new FlxActionDigital(Action.NN3);
	var _nn4 = new FlxActionDigital(Action.NN4);
	var _nn5 = new FlxActionDigital(Action.NN5);
	var _nn6 = new FlxActionDigital(Action.NN6);
	var _nn7 = new FlxActionDigital(Action.NN7);
	var _nn8 = new FlxActionDigital(Action.NN8);
	var _nn9 = new FlxActionDigital(Action.NN9);


	var _nn0P = new FlxActionDigital(Action.NN0_P);
	var _nn1P = new FlxActionDigital(Action.NN1_P);
	var _nn2P = new FlxActionDigital(Action.NN2_P);
	var _nn3P = new FlxActionDigital(Action.NN3_P);
	var _nn4P = new FlxActionDigital(Action.NN4_P);
	var _nn5P = new FlxActionDigital(Action.NN5_P);
	var _nn6P = new FlxActionDigital(Action.NN6_P);
	var _nn7P = new FlxActionDigital(Action.NN7_P);
	var _nn8P = new FlxActionDigital(Action.NN8_P);
	var _nn9P = new FlxActionDigital(Action.NN9_P);

	var _nn0R = new FlxActionDigital(Action.NN0_R);
	var _nn1R = new FlxActionDigital(Action.NN1_R);
	var _nn2R = new FlxActionDigital(Action.NN2_R);
	var _nn3R = new FlxActionDigital(Action.NN3_R);
	var _nn4R = new FlxActionDigital(Action.NN4_R);
	var _nn5R = new FlxActionDigital(Action.NN5_R);
	var _nn6R = new FlxActionDigital(Action.NN6_R);
	var _nn7R = new FlxActionDigital(Action.NN7_R);
	var _nn8R = new FlxActionDigital(Action.NN8_R);
	var _nn9R = new FlxActionDigital(Action.NN9_R);
	...
	public var NN0(get, never):Bool;
	public var NN1(get, never):Bool;
	public var NN2(get, never):Bool;
	public var NN3(get, never):Bool;
	public var NN4(get, never):Bool;
	public var NN5(get, never):Bool;
	public var NN6(get, never):Bool;
	public var NN7(get, never):Bool;
	public var NN8(get, never):Bool;
	public var NN9(get, never):Bool;

	public var NN0_P(get, never):Bool;
	public var NN1_P(get, never):Bool;
	public var NN2_P(get, never):Bool;
	public var NN3_P(get, never):Bool;
	public var NN4_P(get, never):Bool;
	public var NN5_P(get, never):Bool;
	public var NN6_P(get, never):Bool;
	public var NN7_P(get, never):Bool;
	public var NN8_P(get, never):Bool;
	public var NN9_P(get, never):Bool;

	public var NN0_R(get, never):Bool;
	public var NN1_R(get, never):Bool;
	public var NN2_R(get, never):Bool;
	public var NN3_R(get, never):Bool;
	public var NN4_R(get, never):Bool;
	public var NN5_R(get, never):Bool;
	public var NN6_R(get, never):Bool;
	public var NN7_R(get, never):Bool;
	public var NN8_R(get, never):Bool;
	public var NN9_R(get, never):Bool;

	inline function get_NN0() return _nn0.check();
	inline function get_NN1() return _nn1.check();
	inline function get_NN2() return _nn2.check();
	inline function get_NN3() return _nn3.check();
	inline function get_NN4() return _nn4.check();
	inline function get_NN5() return _nn5.check();
	inline function get_NN6() return _nn6.check();
	inline function get_NN7() return _nn7.check();
	inline function get_NN8() return _nn8.check();
	inline function get_NN9() return _nn9.check();

	inline function get_NN0_P() return _nn0P.check();
	inline function get_NN1_P() return _nn1P.check();
	inline function get_NN2_P() return _nn2P.check();
	inline function get_NN3_P() return _nn3P.check();
	inline function get_NN4_P() return _nn4P.check();
	inline function get_NN5_P() return _nn5P.check();
	inline function get_NN6_P() return _nn6P.check();
	inline function get_NN7_P() return _nn7P.check();
	inline function get_NN8_P() return _nn8P.check();
	inline function get_NN9_P() return _nn9P.check();

	inline function get_NN0_R() return _nn0R.check();
	inline function get_NN1_R() return _nn1R.check();
	inline function get_NN2_R() return _nn2R.check();
	inline function get_NN3_R() return _nn3R.check();
	inline function get_NN4_R() return _nn4R.check();
	inline function get_NN5_R() return _nn5R.check();
	inline function get_NN6_R() return _nn6R.check();
	inline function get_NN7_R() return _nn7R.check();
	inline function get_NN8_R() return _nn8R.check();
	inline function get_NN9_R() return _nn9R.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case NN0:
				func(_nn0, PRESSED);
				func(_nn0P, JUST_PRESSED);
				func(_nn0R, JUST_RELEASED);
			case NN1:
				func(_nn1, PRESSED);
				func(_nn1P, JUST_PRESSED);
				func(_nn1R, JUST_RELEASED);
			case NN2:
				func(_nn2, PRESSED);
				func(_nn2P, JUST_PRESSED);
				func(_nn2R, JUST_RELEASED);
			case NN3:
				func(_nn3, PRESSED);
				func(_nn3P, JUST_PRESSED);
				func(_nn3R, JUST_RELEASED);
			case NN4:
				func(_nn4, PRESSED);
				func(_nn4P, JUST_PRESSED);
				func(_nn4R, JUST_RELEASED);
			case NN5:
				func(_nn5, PRESSED);
				func(_nn5P, JUST_PRESSED);
				func(_nn5R, JUST_RELEASED);
			case NN6:
				func(_nn6, PRESSED);
				func(_nn6P, JUST_PRESSED);
				func(_nn6R, JUST_RELEASED);
			case NN7:
				func(_nn7, PRESSED);
				func(_nn7P, JUST_PRESSED);
				func(_nn7R, JUST_RELEASED);
			case NN8:
				func(_nn8, PRESSED);
				func(_nn8P, JUST_PRESSED);
				func(_nn8R, JUST_RELEASED);
			case NN9:
				func(_nn9, PRESSED);
				func(_nn9P, JUST_PRESSED);
				func(_nn9R, JUST_RELEASED);
		}
	}
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		inline bindKeys(Control.NN0, [Q]);
		inline bindKeys(Control.NN1, [W]);
		inline bindKeys(Control.NN2, [E]);
		inline bindKeys(Control.NN3, [R]);
		inline bindKeys(Control.NN4, [C]);
		inline bindKeys(Control.NN5, [N]);
		inline bindKeys(Control.NN6, [U]);
		inline bindKeys(Control.NN7, [I]);
		inline bindKeys(Control.NN8, [O]);
		inline bindKeys(Control.NN9, [P]);

		inline bindKeys(Control.NN4, [T]);
		inline bindKeys(Control.NN5, [Y]);
		...
		bindKeys(Control.NN0, [Q]);
		bindKeys(Control.NN1, [W]);
		bindKeys(Control.NN2, [E]);
		bindKeys(Control.NN3, [R]);
		bindKeys(Control.NN4, [C]);
		bindKeys(Control.NN5, [N]);
		bindKeys(Control.NN6, [U]);
		bindKeys(Control.NN7, [I]);
		bindKeys(Control.NN8, [O]);
		bindKeys(Control.NN9, [P]);

		bindKeys(Control.NN4, [T]);
		bindKeys(Control.NN5, [Y]);
		switch (scheme)
		{
			case Solo:
